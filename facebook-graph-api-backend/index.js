...
app.get('/api/page-insights', async (req, res) => {
    ...
    try {
        const insightsResponse = await axios.get(
            `https://graph.facebook.com/${page_id}/insights?metric=page_fans,page_post_engagements,page_actions_post_reactions_total,page_impressions&period=week&since=${since}&until=${until}&access_token=${access_token}`
        );
